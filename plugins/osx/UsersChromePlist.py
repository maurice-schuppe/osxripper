...
class UsersChromePlist(Plugin):
    """
    Parse information from /Users/username/Library/Preferences/com.google.Chrome.plist
    """
    ...
    def __parse_bplist(self, file, username):
        ...
        with codecs.open(os.path.join(self._output_dir, "Users_" + username + "_Chrome.txt"), "a",
            ...
            if self._os_version in ["mojave", "sierra", "el_capitan", "yosemite",
