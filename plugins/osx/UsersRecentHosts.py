...
class UsersRecentHosts(Plugin):
    ...
    def __init__(self):
        ...
        self._description = "Parse information from /Users/username/Library/" \
                            "Application Support/com.apple.sharedfilelist/com.apple.LSSharedFileList.RecentHosts.sfl"
        self._data_file = "com.apple.LSSharedFileList.RecentHosts.sfl"
        self._output_file = "_RecentHosts.txt"
        self._type = "bplist"
