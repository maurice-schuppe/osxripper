...
class UsersVMWare(Plugin):
    ...
    def __init__(self):
        ...
        self._description = "Parse information from /Users/{username}/Library/Application Support/VMware Fusion/vmInventory file"
    ...
    def __parse_config(self, file, username):
        ...
        """
        with codecs.open(os.path.join(self._output_dir, "Users_" + username + "_VMware_inventory.txt"), "a", encoding="utf-8") as of:
